...
skills = [
	...
	("leadership", "Leadership", sf_base_att_cha, 10, "Every_point_increases_maximum_number_of_troops_you_can_command_by_8,_increases_your_party_morale_and_reduces_troop_wages_by_5%%._(Leader_skill)"),
	...
	("foraging", "Foraging", sf_base_att_agi|sf_effects_party, 10, "Allows_the_party_to_forage_for_5_food_per_skill_level_(camp,_siege,_raiding)_and_increase_foraging_range_(Party_skill)_Max_level:_10."),
	...
	("athletics", "Athletics", sf_base_att_agi, 10, "Improves_your_running_speed_and_decreases_the_chance_you'll_stumble._(Personal_skill)"),
