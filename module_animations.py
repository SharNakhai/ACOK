...
animations = [
	...
	["walk_forward_crouch", acf_enforce_lowerbody, 0,
		[1.7, "low_walk", 0, 48, arf_use_walk_progress, 58726, (0.0, 0.0, 0.0), 0.0]
	],
	...
	["ready_bow", acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_rider_rot_bow|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction,
		[1.5, "anim_human", 20500, 20530, arf_blend_in_6|arf_make_custom_sound, 28707, (0.0, 0.0, 0.0), 0.0]
	],
	...
	["reload_crossbow", 0, amf_priority_reload|amf_use_weapon_speed|amf_play,
		[1.0, "anim_human", 21700, 21750, arf_blend_in_8|arf_make_custom_sound, 61286, (0.0, 0.0, 0.0), 0.0]
	],
	...
	["ready_pistol", acf_rot_vertical_sword|acf_anim_length(100), amf_priority_attack|amf_rider_rot_pistol|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction,
	...
	["ready_slashleft_twohanded", acf_right_cut|acf_rot_vertical_bow|acf_anim_length(100), amf_priority_attack|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction|amf_use_inertia,
	...
	["ready_slash_horseback_polearm_right", acf_right_cut|acf_rot_vertical_sword|acf_anim_length(100), amf_priority_attack|amf_rider_rot_swing_right|amf_use_weapon_speed|amf_keep|amf_client_owner_prediction|amf_use_inertia,
		[0.35, "attacks_staff_righttoleft", 6, 16, arf_blend_in_6]
	],

	["release_slash_horseback_polearm_right", acf_right_cut|acf_rot_vertical_sword|acf_anim_length(100), amf_priority_attack|amf_rider_rot_swing_right|amf_use_weapon_speed|amf_play|amf_continue_to_next,
	...
	["shield_strike", acf_align_with_ground|acf_enforce_all, amf_priority_striked|amf_accurate_body|amf_play|amf_restart,
		[2.0, "anim_human", 45000, 45010, arf_blend_in_3|arf_make_custom_sound],
	...
	["unused_human_anim_20", 0, 0,
		[1.0, "anim_human", 0, 1, 0]
	],

	["unused_human_anim_21", 0, 0,
		[1.0, "anim_human", 0, 1, 0]
	],

	["unused_human_anim_22", 0, 0,
		[1.0, "anim_human", 0, 1, 0]
	],

	["unused_human_anim_23", 0, 0,
		[1.0, "anim_human", 0, 1, 0]
	],

	["unused_human_anim_24", 0, 0,
		[1.0, "anim_human", 0, 1, 0]
	],

	["unused_human_anim_25", 0, 0,
		[1.0, "anim_human", 0, 1, 0]
	],

	["unused_human_anim_26", 0, 0,
		[1.0, "anim_human", 0, 1, 0]
	],

	["unused_human_anim_27", 0, 0,
		[1.0, "anim_human", 0, 1, 0]
	],

	["unused_human_anim_28", 0, 0,
		[1.0, "anim_human", 0, 1, 0]
	],

	["unused_human_anim_29", 0, 0,
		[1.0, "anim_human", 0, 1, 0]
	],

	["unused_human_anim_30", 0, 0,
		[1.0, "anim_human", 0, 1, 0]
	],

	["unused_human_anim_31", 0, 0,
		[1.0, "anim_human", 0, 1, 0]
	],

	["unused_human_anim_32", 0, 0,
		[1.0, "anim_human", 0, 1, 0]
	],

	["unused_human_anim_33", 0, 0,
		[1.0, "anim_human", 0, 1, 0]
	],

	["unused_human_anim_34", 0, 0,
		[1.0, "anim_human", 0, 1, 0]
	],

	["unused_human_anim_35", 0, 0,
		[1.0, "anim_human", 0, 1, 0]
	],

	["unused_human_anim_36", 0, 0,
		[1.0, "anim_human", 0, 1, 0]
	],

	["unused_human_anim_37", 0, 0,
		[1.0, "anim_human", 0, 1, 0]
	],

	["unused_human_anim_38", 0, 0,
		[1.0, "anim_human", 0, 1, 0]
	],

	["unused_human_anim_39", 0, 0,
		[1.0, "anim_human", 0, 1, 0]
	],

	["unused_human_anim_40", 0, 0,
		[1.0, "anim_human", 0, 1, 0]
	],

	["unused_human_anim_41", 0, 0,
		[1.0, "anim_human", 0, 1, 0]
	],

	["unused_human_anim_42", 0, 0,
		[1.0, "anim_human", 0, 1, 0]
	],

	["unused_human_anim_43", 0, 0,
		[1.0, "anim_human", 0, 1, 0]
	],
	...
	["sitting_drinking_low", acf_enforce_all, amf_priority_die|amf_play,
		[20.0, "dedal_sitting_drinking_low", 0, 311, arf_cyclic|arf_use_stand_progress, 0, (0.0, 0.0, 0.0), 0.25]
	],

	["sitting_low", acf_enforce_all, amf_priority_die|amf_keep,
		[18.0, "dedal_sitting_low", 3, 301, arf_cyclic|arf_use_stand_progress, 0, (0.0, 0.0, 0.0), 0.25]
	],

	["lute_sitting", acf_enforce_all, amf_priority_die|amf_play,
		[2.05, "dedal_lute_sitting", 3, 7, arf_cyclic|arf_use_stand_progress, 0, (0.0, 0.0, 0.0), 0.25]
	],

	["lute_standing", acf_enforce_all, amf_priority_die|amf_play,
		[2.05, "dedal_lute_standing", 3, 7, arf_cyclic|arf_use_stand_progress, 0, (0.0, 0.0, 0.0), 0.25]
	],

	["lyre_sitting", acf_enforce_all, amf_priority_die|amf_play,
		[2.05, "dedal_lyre_sitting", 3, 7, arf_cyclic|arf_use_stand_progress, 0, (0.0, 0.0, 0.0), 0.25]
	],

	["lyre_standing", acf_enforce_all, amf_priority_die|amf_play,
		[2.05, "dedal_lyre_standing", 3, 7, arf_cyclic|arf_use_stand_progress, 0, (0.0, 0.0, 0.0), 0.25]
	],

	["feeble_lord", acf_enforce_all, amf_priority_die|amf_keep,
		[18.0, "dedal_sitting_low", 3, 301, arf_cyclic|arf_use_stand_progress, 0, (0.0, 0.0, 0.0), 0.25]
	],
