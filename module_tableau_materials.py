...
tableaus = [
	...
	[
		...
		(position_set_z, 1, 50),
		(position_set_x, 1, 5),
		(position_set_y, 1, 134),
		(cur_tableau_add_mesh, ":script_param_1", 1, 98, 0),
		(init_position, 1),
		(position_set_z, 1, 100),
	...
	[
		...
		(position_set_x, 1, 10),
		(position_set_y, 1, 150),
		(cur_tableau_add_mesh, ":script_param_1", 1, 78, 0),
		(init_position, 1),
		(position_set_z, 1, 100),
	...
	[
		...
		(position_set_x, 1, -56),
		(position_set_y, 1, 160),
		(cur_tableau_add_mesh, ":script_param_1", 1, 100, 0),
		(init_position, 1),
		(position_set_z, 1, 100),
	...
	[
		...
		(cur_tableau_add_mesh, ":script_param_1", 1, 107, 0),
		(init_position, 1),
		(position_set_z, 1, 100),
	...
	[
		...
		(position_set_x, 1, 17),
		(position_set_y, 1, 150),
		(cur_tableau_add_mesh, ":script_param_1", 1, 86, 0),
		(init_position, 1),
		(position_set_z, 1, 30),
		(cur_tableau_add_mesh, "mesh_ar_pla_t6_heraldic_tableau_banner", 1, 0, 0),
		(cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000)
	]),
	...
	[
		...
		(init_position, 1),
		(position_set_z, 1, 100),
		(cur_tableau_add_mesh, "mesh_tableau_mesh_mail_long_surcoat_new_heraldic", 1, 0, 0),
		(cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000)
	]),
	...
	[
		...
		(init_position, 1),
		(position_set_z, 1, 100),
		(cur_tableau_add_mesh, "mesh_tableau_mesh_brigandine_b_heraldic", 1, 0, 0),
		(cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000)
	]),
	...
	[
		...
		(init_position, 1),
		(position_set_z, 1, 100),
		(cur_tableau_add_mesh, "mesh_tableau_mesh_heraldic_tunic_new", 1, 0, 0),
		(cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000)
	]),
	...
	[
		...
		(position_set_x, 1, -12),
		(position_set_y, 1, 70),
		(cur_tableau_add_mesh, ":script_param_1", 1, 40, 0),
		(init_position, 1),
		(position_set_z, 1, 100),
		(cur_tableau_add_mesh, "mesh_tableau_mesh_costumes6_banner", 1, 0, 0),
		(cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000)
	]),
	...
	[
		...
		(init_position, 1),
		(position_set_z, 1, 100),
		(cur_tableau_add_mesh, "mesh_tableau_mesh_costumes9_banner", 1, 0, 0),
		(cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000)
	]),

	("cor_herald", 0, "sample_cor_banner", 512, 512, 0, 0, 0, 0,
	[
		(store_script_param, ":script_param_1", 1),
		(set_fixed_point_multiplier, 100),
		(store_sub, ":value", ":script_param_1", "mesh_arms_a01"),
		...
		(cur_tableau_add_mesh, ":script_param_1", 1, 96, 0),
		(init_position, 1),
		(position_set_z, 1, 30),
		(cur_tableau_add_mesh, "mesh_tableau_mesh_cor_banner", 1, 0, 0),
		(cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000)
	]),

	("heraldic_shirt", 0, "sample_heraldic_shirt_banner", 1024, 1024, 0, 0, 0, 0,
	[
		(store_script_param, ":script_param_1", 1),
		(set_fixed_point_multiplier, 100),
		(store_sub, ":value", ":script_param_1", "mesh_arms_a01"),
		...
		(position_set_x, 1, 14),
		(position_set_y, 1, 150),
		(cur_tableau_add_mesh, ":script_param_1", 1, 95, 0),
		(init_position, 1),
		(position_set_z, 1, 30),
		(cur_tableau_add_mesh, "mesh_tableau_mesh_heraldic_shirt_banner", 1, 0, 0),
		(cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000)
	]),
	...
	[
		...
		(position_set_x, 1, -60),
		(position_set_y, 1, 140),
		(cur_tableau_add_mesh, ":script_param_1", 1, 94, 0),
		(init_position, 1),
		(position_set_z, 1, 30),
		(cur_tableau_add_mesh, "mesh_tableau_mesh_heraldic_tabard_banner", 1, 0, 0),
		(cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000)
	]),
	...
	[
		...
		(init_position, 1),
		(position_set_z, 1, 30),
		(cur_tableau_add_mesh, "mesh_tableau_mesh_heraldic_mail_and_plate_banner", 1, 0, 0),
		(cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000)
	]),
	...
	[
		...
		(init_position, 1),
		(position_set_z, 1, 30),
		(cur_tableau_add_mesh, "mesh_tableau_mesh_heraldic_light_mail_and_plate_banner", 1, 0, 0),
		(cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000)
	]),
	...
	[
		...
		(cur_tableau_add_mesh, ":script_param_1", 1, 65, 0),
		(init_position, 1),
		(position_set_z, 1, 30),
		(cur_tableau_add_mesh, "mesh_tableau_mesh_heraldic_cuir_bouilli_banner", 1, 0, 0),
		(cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000)
	]),
	...
	[
		...
		(init_position, 1),
		(position_set_z, 1, 30),
		(cur_tableau_add_mesh, "mesh_tableau_mesh_heraldic_padded_cloth_banner", 1, 0, 0),
		(cur_tableau_set_camera_parameters, 0, 200, 200, 0, 100000)
	]),
	...
	[
		...
		(try_begin),
			...
			(store_add, ":value", "spr_banner_lords_sarranid21", 1),
